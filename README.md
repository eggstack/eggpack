...
The first production crate, `eggpack-contract`, implements the portable
...
schema-v1 predecessor. Contract conformance validators and a concrete release
manifest are the next planned capabilities.
