...
| Build and qualification | active | `plans/subsystems/build-qualification-roadmap.md` | M001-M004 closed; M005 ready | refined M005 `fd7adde`; deterministic verified-Zig/cargo-zigbuild provisioning is the sole remaining first-consumer prerequisite |
...
| Build and qualification | M005 deterministic cross-tool provisioning | ready | `plans/implementation/build-qualification/005-deterministic-cross-tool-provisioning.md` | refined at `fd7adde`; exact Zig 0.14.1 / cargo-zigbuild 0.23.3 provisioning, verified Zig path binding, private cargo-zigbuild cache; M003d already closed |
